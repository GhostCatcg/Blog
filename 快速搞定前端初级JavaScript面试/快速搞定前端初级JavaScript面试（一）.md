...
`let b = a`  
`a = 200`
![](https://imgkr.cn-bj.ufileos.com/57471bdd-5570-4d99-9038-36bd70f47cd8.png)

`let a = { age: 20 }` \
`let b = a` \
`b.age = 21`

![](https://imgkr.cn-bj.ufileos.com/150246cc-68ac-4ca2-8db0-d70b9e82bf11.png)
...
```
> typeof 能识别引用类型（不能再继续识别,识别不出来是数组、对象或者null）
```javascript
// 能识别引用类型（不能再继续识别）
typeof null  // 'object'
typeof ['a', 'b']  // 'object'
